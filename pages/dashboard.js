...
export async function getStaticProps() {
  ...
  [
    ...
    },
    {
      ...
      "HIDING GAME VOLUME" : {route2: r3, identifier2: 'days', type: "Bar", filter1: ["week", "month", "all"], filter2: ["dai", "eth"] , prefix: "$", size: 2},
      "UNIQUE ORDERS FILLED" : {size: 1},
      "HIDING GAME VOLUME TO DATE" : {prefix: "Ξ ", filter1: ["dai", "eth"], size: 1},
      "DISTRIBUTED ROOK REWARDS" : {prefix: "$", size: 1},
    },
    {
      "HISTORICAL ROOK APY" : {route2: r3, identifier2: 'days', type: "Bar", suffix: "% APY", size: 2},
      "HISTORICAL SUPPLY/BORROW" : {route2: r3, identifier2: "days", type: "Area", filter2: ["supply", "borrow"], prefix: "$", size: 2},
    ...
    {
      "HISTORICAL APY" : {route2: r3, identifier2: 'days', type: "Bar", filter2: ["dai pool", "eth pool"], suffix: "% APY", size: 2},
      "TOTAL FEES COLLECTED" : {prefix: "$", filter2: ["dai pool", "eth pool"], size: 1},
